...
import { getCurrentScope, ref, watchEffect, getCurrentInstance, onBeforeUnmount, onDeactivated, onActivated, createApp, provide, onErrorCaptured, onServerPrefetch, unref, createVNode, resolveDynamicComponent, shallowReactive, reactive, effectScope, hasInjectionContext, inject, defineAsyncComponent, mergeProps, defineComponent, withCtx, toRef, computed, shallowRef, h, isVNode, createCommentVNode, isReadonly, Suspense, nextTick, Fragment, useSSRContext, isRef, isShallow, isReactive, toRaw } from 'vue';
import { e as createError, o as defu, p as parseURL, f as encodePath, q as decodePath, w as withQuery, v as hasProtocol, x as isScriptProtocol, l as joinURL, y as sanitizeStatusCode, $ as $fetch } from '../_/nitro.mjs';
...
var virtual_nuxt_node_modules_2F_cache_2Fnuxt_2F_nuxt_2Froutes_default = [
	...
	},
	{
		name: "about",
		path: "/about",
		component: () => import('../build/about-SfQv-Pj0.mjs')
	},
	{
		name: "accountability",
		path: "/accountability",
	...
	},
	{
		name: "activities",
		path: "/activities",
		component: () => import('../build/activities-Doe9DqLQ.mjs')
	},
	{
		name: "contact",
		path: "/contact",
	...
	},
	{
		name: "impact",
		path: "/impact",
		component: () => import('../build/impact-g5kP0D78.mjs')
	},
	{
		name: "news",
		path: "/news",
		component: () => import('../build/news-BGhFG4Or.mjs')
	},
	{
		name: "out-growers",
		path: "/out-growers",
		component: () => import('../build/out-growers-BiBdLzVn.mjs')
	},
	{
		name: "privacy",
		path: "/privacy",
		component: () => import('../build/privacy-BgKPrRnm.mjs')
	},
	{
		name: "products",
		path: "/products",
		component: () => import('../build/products-DIUldbjS.mjs')
	},
	{
		name: "programs",
		path: "/programs",
...
var nuxt_layout_default = defineComponent({
	...
	setup(props, context) {
		...
		const route = !injectedRoute || injectedRoute === useRoute$2() ? useRoute() : injectedRoute;
...
var app_vue_vue_type_script_setup_true_lang_default = /*@__PURE__*/ defineComponent({
	...
	setup(__props) {
		...
		const siteUrl = (/* @__PURE__ */ useRuntimeConfig()).public.siteUrl;
		useSeoMeta$1({
		...
		useHead$1(() => ({
			...
			script: [{
				...
				children: JSON.stringify({
					...
					address: {
						"@type": "PostalAddress",
						streetAddress: "52 Kampala Road, King Fahad Plaza, 3rd Floor",
