...
var programs = [
	{
		...
		details: ["The source project identifies farming advisory as its primary focus.", "Detailed objectives, dates, partners, beneficiary definitions and verified results require programme-owner approval."],
	...
	},
	{
		...
		details: ["The source project identifies dry processing as its primary focus.", "Facility capacity, commissioning date, partners, quality results and supporting documents require verification."],
	...
	},
	{
		...
		details: ["The source project identifies the Mt. Elgon region and commercial farming as its focus.", "Estate size, varieties, production volumes, certifications and verified outcomes require confirmation."],
	...
	},
	{
		...
		details: ["The source project identifies export-lot traceability technology as its focus.", "System scope, implementation date, data controls, verification method and buyer-facing outputs require confirmation."],
	...
	},
	{
		...
		details: ["The source project identifies women in coffee and Central Uganda as its focus.", "Activities, participant definitions, dates, partners, safeguards and verified results require confirmation."],
	...
	},
	{
		...
		details: ["The source project identifies branding, packaging and national reach as its focus.", "Launch date, product range, packaging formats, distribution footprint and commercial results require confirmation."],
		image: "/assets/images/programs/project-one-6.jpg"
	}
];
var newsArticles = [];

export { accountabilityResources as a, newsArticles as n, programs as p, valueChains as v };
//# sourceMappingURL=reviewed-CbsaqwN4.mjs.map
