...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"theme-color","content":"#1B5E20"},{"name":"description","content":"AFRICOFF Industries connects Ugandan coffee growers with quality processing and global markets."},{"name":"robots","content":"index, follow"}],"link":[],"style":[],"script":[],"noscript":[],"htmlAttrs":{"lang":"en"},"titleTemplate":"%s · AFRICOFF Industries (U) Limited"};
