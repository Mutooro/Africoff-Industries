import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};globalThis.__timing__.logStart('Load chunks/virtual/entry');import { defineProdDiagnostics } from 'file://D:/martin/AFRICOFF-NEW/AFFRICOFF-NEW/node_modules/nostics/dist/index.mjs';
import { ansiFormatter } from 'file://D:/martin/AFRICOFF-NEW/AFFRICOFF-NEW/node_modules/nostics/dist/formatters/ansi.mjs';
import { getCurrentScope, ref, watchEffect, getCurrentInstance, onBeforeUnmount, onDeactivated, onActivated, createApp, provide, onErrorCaptured, onServerPrefetch, unref, createVNode, resolveDynamicComponent, shallowReactive, reactive, effectScope, hasInjectionContext, inject, defineAsyncComponent, mergeProps, toRef, shallowRef, isReadonly, defineComponent, h, computed, useSSRContext, isRef, isShallow, isReactive, toRaw, isVNode, createCommentVNode, withCtx, Suspense, nextTick, Fragment } from 'file://D:/martin/AFRICOFF-NEW/AFFRICOFF-NEW/node_modules/vue/index.mjs';
import { createHooks, createDebugger } from 'file://D:/martin/AFRICOFF-NEW/AFFRICOFF-NEW/node_modules/hookable/dist/index.mjs';
import { getContext, executeAsync } from 'file://D:/martin/AFRICOFF-NEW/AFFRICOFF-NEW/node_modules/unctx/dist/index.mjs';
import { createError, sanitizeStatusCode } from 'file://D:/martin/AFRICOFF-NEW/AFFRICOFF-NEW/node_modules/h3/dist/index.mjs';
import { hasProtocol, joinURL, withQuery, parseURL, encodePath, decodePath, isScriptProtocol } from 'file://D:/martin/AFRICOFF-NEW/AFFRICOFF-NEW/node_modules/ufo/dist/index.mjs';
import { $fetch } from 'file://D:/martin/AFRICOFF-NEW/AFFRICOFF-NEW/node_modules/ofetch/dist/node.mjs';
import { i as injectHead$1, V as VueResolver, b as baseURL, h as headSymbol } from '../_/renderer.mjs';
import { createMemoryHistory, createRouter, START_LOCATION, useRoute, RouterView } from 'file://D:/martin/AFRICOFF-NEW/AFFRICOFF-NEW/node_modules/vue-router/vue-router.node.mjs';
import { defu } from 'file://D:/martin/AFRICOFF-NEW/AFFRICOFF-NEW/node_modules/defu/dist/defu.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode } from 'file://D:/martin/AFRICOFF-NEW/AFFRICOFF-NEW/node_modules/vue/server-renderer/index.mjs';
import { FlatMetaPlugin } from 'file://D:/martin/AFRICOFF-NEW/AFFRICOFF-NEW/node_modules/unhead/dist/plugins.mjs';
import { hasOwn, walkResolver } from 'file://D:/martin/AFRICOFF-NEW/AFFRICOFF-NEW/node_modules/unhead/dist/utils.mjs';
...
var virtual_nuxt__nuxt_2Froutes_default = [
	{
		name: "about",
		path: "/about",
		component: () => import('../build/about-DtoJymM8.mjs')
	},
	{
		name: "activities",
		path: "/activities",
		component: () => import('../build/activities-D72rV9KJ.mjs')
	},
	{
		name: "contact",
		path: "/contact",
		component: () => import('../build/contact-C-JSohF3.mjs')
	},
	{
		name: "impact",
		path: "/impact",
		component: () => import('../build/impact-FysVFQB-.mjs')
	},
	{
		name: "out-growers",
		path: "/out-growers",
		component: () => import('../build/out-growers-DBlbggzz.mjs')
	},
	{
		name: "privacy",
		path: "/privacy",
		component: () => import('../build/privacy-hxCBG1WO.mjs')
	},
	{
		name: "products",
		path: "/products",
		component: () => import('../build/products-3Z_9T7Pj.mjs')
	},
	{
		name: "index",
		path: "/",
		component: () => import('../build/pages-DxVFPl1W.mjs')
	}
];
//#endregion
...
var virtual_nuxt__nuxt_2Flayouts_default = { default: defineAsyncComponent(() => import('../build/default-B0bJ9mue.mjs').then((m) => m.default || m)) };
//#endregion
...
var _sfc_main$1 = {
	...
	setup(__props) {
		...
		const stack = void 0;
		const _Error404 = defineAsyncComponent(() => import('../build/error-404-DvWzlTVp.mjs'));
		const _Error = defineAsyncComponent(() => import('../build/error-500-BwFlv8H2.mjs'));
...
export { _plugin_vue_export_helper_default as _, useRoute$1 as a, useHead$1 as b, useRouter as c, useRuntimeConfig as d, encodeRoutePath as e, useNuxtApp as f, nuxtLinkDefaults as g, entry as h, navigateTo as n, resolveRouteObject as r, useSeoMeta$1 as u };;globalThis.__timing__.logEnd('Load chunks/virtual/entry');
