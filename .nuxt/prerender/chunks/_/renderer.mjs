globalThis.__timing__.logStart('Load chunks/_/renderer');import { AsyncLocalStorage } from 'node:async_hooks';
import { a as useStorage, b as useRuntimeConfig, d as defineRenderHandler, g as getRouteRules, u as useNitroApp } from './nitro.mjs';
import { encodePath, joinRelativeURL, joinURL } from 'file://D:/martin/AFRICOFF-NEW/AFFRICOFF-NEW/node_modules/ufo/dist/index.mjs';
...
import { hasInjectionContext, inject, isRef, toValue } from 'file://D:/martin/AFRICOFF-NEW/AFFRICOFF-NEW/node_modules/vue/index.mjs';
...
import { getResponseStatusText, getResponseStatus, getQuery, createError, appendResponseHeader } from 'file://D:/martin/AFRICOFF-NEW/AFFRICOFF-NEW/node_modules/h3/dist/index.mjs';
...
import { relative } from 'file://D:/martin/AFRICOFF-NEW/AFFRICOFF-NEW/node_modules/pathe/dist/index.mjs';
...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"theme-color","content":"#0d4a2a"},{"name":"description","content":"AFRICOFF Industries connects Ugandan coffee growers with quality processing and global markets."}],"link":[],"style":[],"script":[],"noscript":[],"htmlAttrs":{"lang":"en"},"titleTemplate":"%s · AFRICOFF Industries (U) Limited"};
...
const entryFileName = "DDLQOM5N.js";
...
export { VueResolver as V, baseURL as b, headSymbol as h, injectHead as i, publicAssetsURL as p, renderer as r };;globalThis.__timing__.logEnd('Load chunks/_/renderer');
